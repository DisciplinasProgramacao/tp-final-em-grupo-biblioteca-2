...
public class Main {
	...
	public static void main(String[] args) {
		...
		EmprestimoFisico e=new EmprestimoFisico(atual);
		EmprestimoDigital ed=new EmprestimoDigital(atual);
    		...
    		switch (opcao)
           	...
           	case 1:
           		...
           		if (opcao2==1)
           		{
           			...
           			Usuario u=new AlunoDeGraduacao(teclado.next());
           			usuarios.add(u);
           			b.cadastraUsuario(u);
           		...
           		{
           		System.out.println("Digite os dados do usuario [nome]");
           		Usuario u=new AlunoDePosGraduacao(teclado.next());
       			usuarios.add(u);
       			b.cadastraUsuario(u);
       			break;
           	    }
           		...
           		{
           			System.out.println("Digite os dados do usuario [nome]");
           			Usuario u=new Professores(teclado.next());
           			usuarios.add(u);
           			b.cadastraUsuario(u);
           			break;
           		}
